...
<div class="panel mb-3" id="app">
    <div class="panel-header"><?= $this->title ?><span class="point">(可复制相应模板ID到微信小程序后台搜索)</span></div>
        ...
        <form class="auto-form" method="post">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['store']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">订单支付(模板ID: AT0009 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">订单取消(模板ID: AT0024 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">订单发货(模板ID: AT0007 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">订单退款(模板ID: AT0036 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['share']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">提现成功(模板ID: AT0830 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">提现失败(模板ID: AT1242 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">分销审核(模板ID: AT0674 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['pintuan']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">拼团成功通知(模板ID: AT0051 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">拼团失败通知(模板ID: AT0310 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['book']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">预约成功(模板ID: AT0009 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">预约失败(模板ID: AT0036 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['mch']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">审核结果通知(模板ID: AT0146 )</label>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">新订单通知(模板ID: AT0079 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['fxhb']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">账户变动通知(模板ID: AT0677 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                ...
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['lottery']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">中奖结果通知(模板ID: AT1186 )</label>
                    </div>
                    <div class="col-sm-6">
            ...
            <fieldset
                    style="margin: 8px; border: 1px solid silver; padding: 8px; border-radius: 4px;<?= $tplMsg['activity']['is_show'] ? '' : 'display: none' ?>">
                <legend style="color:#333333; font-size:0.8em; font-weight:bold;">
                    关联模块：<span style="color: red;"><?= $tplMsg['activity']['plugin'] ?></span>
                </legend>
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">活动参与成功(模板ID: AT1348 )</label>
                    </div>
                    <div class="col-sm-6">
                        <input class="form-control" name="activity_success_tpl" placeholder="请输入模版 ID ..."
                               value="<?= isset($tplMsg['activity']['success_tpl']) ? $tplMsg['activity']['success_tpl'] : '' ?>">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-3 text-right">
                        <label class="col-form-label">活动参与失败(模板ID: AT1863 )</label>
                    </div>
                    <div class="col-sm-6">
                        <input class="form-control" name="activity_refund_tpl" placeholder="请输入模版 ID ..."
                               value="<?= isset($tplMsg['activity']['refund_tpl']) ? $tplMsg['activity']['refund_tpl'] : '' ?>">
