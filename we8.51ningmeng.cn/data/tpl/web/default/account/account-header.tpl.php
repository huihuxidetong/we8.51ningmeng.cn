...
<div class="btn-group we7-btn-group wechat-edit-group">
	...
	<?php  } ?>
	<?php  if(ACCOUNT_TYPE == ACCOUNT_TYPE_PHONEAPP_NORMAL) { ?>
	<a href="<?php  echo url('phoneapp/manage/display', array('uniacid' => $account['uniacid'], 'acid' => $account['acid'], 'account_type' => ACCOUNT_TYPE))?>" class="btn btn-default <?php  if($action == 'manage' && $do == 'display') { ?> active<?php  } ?>">版本管理</a>
	<?php  } ?>
	<?php  if(ACCOUNT_TYPE == ACCOUNT_TYPE_ALIAPP_NORMAL) { ?>
	<a href="<?php  echo url('miniapp/manage/display', array('uniacid' => $account['uniacid'], 'acid' => $account['acid'], 'account_type' => ACCOUNT_TYPE))?>" class="btn btn-default <?php  if($action == 'manage' && $do == 'display') { ?> active<?php  } ?>">版本管理</a>
	<?php  } ?>
